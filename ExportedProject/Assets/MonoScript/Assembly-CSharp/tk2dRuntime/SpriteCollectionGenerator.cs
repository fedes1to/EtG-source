...
namespace tk2dRuntime
{
	internal static class SpriteCollectionGenerator
	{
		...
		{
			return CreateFromTexture(null, texture, size, textureDimensions, names, regions, trimRects, anchors, rotated, string.Empty);
		}
		...
		private static tk2dSpriteDefinition CreateDefinitionForRegionInTexture(string name, Vector2 textureDimensions, float scale, Rect uvRegion, Rect trimRect, Vector2 anchor, bool rotated)
		{
			...
			if (rotated)
			{
				tk2dSpriteDefinition.position0 = new Vector3(0f - vector8.y + vector4.x, vector7.x + vector4.y, 0f);
				tk2dSpriteDefinition.position1 = new Vector3(0f - vector7.y + vector4.x, vector7.x + vector4.y, 0f);
				tk2dSpriteDefinition.position2 = new Vector3(0f - vector8.y + vector4.x, vector8.x + vector4.y, 0f);
				tk2dSpriteDefinition.position3 = new Vector3(0f - vector7.y + vector4.x, vector8.x + vector4.y, 0f);
