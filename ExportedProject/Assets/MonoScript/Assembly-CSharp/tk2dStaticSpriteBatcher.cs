	...
	private void BuildRenderMesh()
	{
		...
		foreach (tk2dBatchedSprite tk2dBatchedSprite3 in array2)
		{
			...
			case tk2dBatchedSprite.Type.SlicedSprite:
				if (spriteDefinition2 != null)
				{
					tk2dSpriteGeomGen.GetSlicedSpriteGeomDesc(out numVertices, out numIndices, spriteDefinition2, tk2dBatchedSprite3.CheckFlag(tk2dBatchedSprite.Flags.SlicedSprite_BorderOnly), false, Vector2.zero, Vector2.zero, Vector2.zero, 0f);
				}
				break;
		...
		foreach (tk2dBatchedSprite tk2dBatchedSprite4 in array9)
		{
			...
			case tk2dBatchedSprite.Type.SlicedSprite:
				if (spriteDefinition3 != null)
				{
					tk2dSpriteGeomGen.SetSlicedSpriteGeom(array10, array11, 0, out boundsCenter, out boundsExtents, spriteDefinition3, tk2dBatchedSprite4.CheckFlag(tk2dBatchedSprite.Flags.SlicedSprite_BorderOnly), Vector3.one, tk2dBatchedSprite4.Dimensions, tk2dBatchedSprite4.SlicedSpriteBorderBottomLeft, tk2dBatchedSprite4.SlicedSpriteBorderTopRight, 0f, tk2dBatchedSprite4.anchor, tk2dBatchedSprite4.BoxColliderOffsetZ, tk2dBatchedSprite4.BoxColliderExtentZ, Vector2.zero, false);
					tk2dSpriteGeomGen.SetSlicedSpriteIndices(array16, 0, num2, spriteDefinition3, tk2dBatchedSprite4.CheckFlag(tk2dBatchedSprite.Flags.SlicedSprite_BorderOnly), false, Vector2.zero, Vector2.zero, Vector2.zero, 0f);
				}
				break;
			case tk2dBatchedSprite.Type.ClippedSprite:
				if (spriteDefinition3 != null)
			...
			case tk2dBatchedSprite.Type.TextMesh:
			{
				...
				int target = tk2dTextGeomGen.SetTextMeshGeom(array10, array11, array12, array13, 0, geomData, int.MaxValue);
