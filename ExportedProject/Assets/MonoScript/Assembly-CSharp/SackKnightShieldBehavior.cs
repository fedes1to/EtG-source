...
public class SackKnightShieldBehavior : AttackBehaviorBase
{
	...
	public override BehaviorResult Update()
	{
		...
		if (m_knight == null || m_knight.CurrentForm != SackKnightController.SackKnightPhase.HOLY_KNIGHT)
		{
	...
	public override ContinuousBehaviorResult ContinuousUpdate()
	{
		...
		if (m_state == State.Charging)
		{
			...
			m_aiAnimator.PlayForDuration("shield", 0.5f, true);
		}
	...
	private void DoMicroBlank()
	{
		...
		if ((bool)m_aiActor.sprite && (bool)m_aiActor.sprite.spriteAnimator && m_aiActor.sprite.spriteAnimator.GetClipByName("owl_hoot") != null)
		{
			m_aiActor.sprite.spriteAnimator.PlayForDuration("owl_hoot", -1f, "owl_idle");
		}
