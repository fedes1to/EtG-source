...
namespace InControl
{
	public class InputDevice
	{
		...
		public GameOptions.ControllerSymbology ControllerSymbology
		{
			get
			{
				return m_controllerSymbology;
			}
			protected set
			{
				m_controllerSymbology = value;
			}
		}
		...
		{
			return LastChangeTime > device.LastChangeTime + 0.5f;
		}
		...
		public bool LastChangedAfter(InputDevice device)
		{
			...
			{
				return LastChangeTick > device.LastChangeTick + 1;
			}
		...
		internal void RequestActivation()
		{
			...
			LastChangeTime = InputManager.CurrentTick;
		}
