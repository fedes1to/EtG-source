...
public class BossStatuesDirectionalWaveAll : Script
{
	...
	protected override IEnumerator Top()
	{
		Fire(new Offset("top 0"), new Direction(120f), new Speed(9f), new EggBullet());
		...
		Fire(new Offset("top 2"), new Direction(60f), new Speed(9f), new EggBullet());
		Fire(new Offset("right 0"), new Direction(30f), new Speed(9f), new EggBullet());
		...
		Fire(new Offset("right 2"), new Direction(-30f), new Speed(9f), new EggBullet());
		Fire(new Offset("bottom 0"), new Direction(-60f), new Speed(9f), new EggBullet());
		...
		Fire(new Offset("bottom 2"), new Direction(-120f), new Speed(9f), new EggBullet());
		Fire(new Offset("left 0"), new Direction(210f), new Speed(9f), new EggBullet());
		...
		Fire(new Offset("left 2"), new Direction(150f), new Speed(9f), new EggBullet());
