...
public class AkSoundEngine
{
	...
	private class AutoObject
	{
		...
		{
			gameObject = go;
			RegisterGameObj(gameObject, (!(gameObject != null)) ? "AkAutoObject" : ("AkAutoObject for " + gameObject.name));
		}
	...
	public static GameObjectHashFunction GameObjectHash
	{
		set
		{
			gameObjectHash = ((value != null) ? value : new GameObjectHashFunction(InternalGameObjectHash));
		}
	}
	...
	public static uint DynamicSequenceOpen(GameObject in_gameObjectID, uint in_uFlags, AkCallbackManager.EventCallback in_pfnCallback, object in_pCookie, AkDynamicSequenceType in_eDynamicSequenceType)
	{
		...
		uint num = AkSoundEnginePINVOKE.CSharp_DynamicSequenceOpen__SWIG_0(akGameObjectID, in_uFlags, (in_uFlags == 0) ? IntPtr.Zero : ((IntPtr)1), (in_pCookie == null) ? IntPtr.Zero : ((IntPtr)in_pCookie.GetHashCode()), (int)in_eDynamicSequenceType);
	...
	public static uint DynamicSequenceOpen(GameObject in_gameObjectID, uint in_uFlags, AkCallbackManager.EventCallback in_pfnCallback, object in_pCookie)
	{
		...
		PreGameObjectAPICall(in_gameObjectID, akGameObjectID);
		in_pCookie = AkCallbackManager.EventCallbackPackage.Create(in_pfnCallback, in_pCookie, ref in_uFlags);
		uint num = AkSoundEnginePINVOKE.CSharp_DynamicSequenceOpen__SWIG_1(akGameObjectID, in_uFlags, (in_uFlags == 0) ? IntPtr.Zero : ((IntPtr)1), (in_pCookie == null) ? IntPtr.Zero : ((IntPtr)in_pCookie.GetHashCode()));
		AkCallbackManager.SetLastAddedPlayingID(num);
		return num;
	}
	...
	public static uint PostEvent(uint in_eventID, GameObject in_gameObjectID, uint in_uFlags, AkCallbackManager.EventCallback in_pfnCallback, object in_pCookie, uint in_cExternals, AkExternalSourceInfo in_pExternalSources, uint in_PlayingID)
	{
		...
		PreGameObjectAPICall(in_gameObjectID, akGameObjectID);
		in_pCookie = AkCallbackManager.EventCallbackPackage.Create(in_pfnCallback, in_pCookie, ref in_uFlags);
		uint num = AkSoundEnginePINVOKE.CSharp_PostEvent__SWIG_0(in_eventID, akGameObjectID, in_uFlags, (in_uFlags == 0) ? IntPtr.Zero : ((IntPtr)1), (in_pCookie == null) ? IntPtr.Zero : ((IntPtr)in_pCookie.GetHashCode()), in_cExternals, AkExternalSourceInfo.getCPtr(in_pExternalSources), in_PlayingID);
		AkCallbackManager.SetLastAddedPlayingID(num);
		return num;
	}
	...
	public static uint PostEvent(uint in_eventID, GameObject in_gameObjectID, uint in_uFlags, AkCallbackManager.EventCallback in_pfnCallback, object in_pCookie, uint in_cExternals, AkExternalSourceInfo in_pExternalSources)
	{
		...
		PreGameObjectAPICall(in_gameObjectID, akGameObjectID);
		in_pCookie = AkCallbackManager.EventCallbackPackage.Create(in_pfnCallback, in_pCookie, ref in_uFlags);
		uint num = AkSoundEnginePINVOKE.CSharp_PostEvent__SWIG_1(in_eventID, akGameObjectID, in_uFlags, (in_uFlags == 0) ? IntPtr.Zero : ((IntPtr)1), (in_pCookie == null) ? IntPtr.Zero : ((IntPtr)in_pCookie.GetHashCode()), in_cExternals, AkExternalSourceInfo.getCPtr(in_pExternalSources));
		AkCallbackManager.SetLastAddedPlayingID(num);
		return num;
	}
	...
	public static uint PostEvent(uint in_eventID, GameObject in_gameObjectID, uint in_uFlags, AkCallbackManager.EventCallback in_pfnCallback, object in_pCookie, uint in_cExternals)
	{
		...
		PreGameObjectAPICall(in_gameObjectID, akGameObjectID);
		in_pCookie = AkCallbackManager.EventCallbackPackage.Create(in_pfnCallback, in_pCookie, ref in_uFlags);
		uint num = AkSoundEnginePINVOKE.CSharp_PostEvent__SWIG_2(in_eventID, akGameObjectID, in_uFlags, (in_uFlags == 0) ? IntPtr.Zero : ((IntPtr)1), (in_pCookie == null) ? IntPtr.Zero : ((IntPtr)in_pCookie.GetHashCode()), in_cExternals);
		AkCallbackManager.SetLastAddedPlayingID(num);
		return num;
	}
	...
	public static uint PostEvent(uint in_eventID, GameObject in_gameObjectID, uint in_uFlags, AkCallbackManager.EventCallback in_pfnCallback, object in_pCookie)
	{
		...
		PreGameObjectAPICall(in_gameObjectID, akGameObjectID);
		in_pCookie = AkCallbackManager.EventCallbackPackage.Create(in_pfnCallback, in_pCookie, ref in_uFlags);
		uint num = AkSoundEnginePINVOKE.CSharp_PostEvent__SWIG_3(in_eventID, akGameObjectID, in_uFlags, (in_uFlags == 0) ? IntPtr.Zero : ((IntPtr)1), (in_pCookie == null) ? IntPtr.Zero : ((IntPtr)in_pCookie.GetHashCode()));
		AkCallbackManager.SetLastAddedPlayingID(num);
		return num;
	}
	...
	public static uint PostEvent(string in_pszEventName, GameObject in_gameObjectID, uint in_uFlags, AkCallbackManager.EventCallback in_pfnCallback, object in_pCookie, uint in_cExternals, AkExternalSourceInfo in_pExternalSources, uint in_PlayingID)
	{
		...
		PreGameObjectAPICall(in_gameObjectID, akGameObjectID);
		in_pCookie = AkCallbackManager.EventCallbackPackage.Create(in_pfnCallback, in_pCookie, ref in_uFlags);
		uint num = AkSoundEnginePINVOKE.CSharp_PostEvent__SWIG_6(in_pszEventName, akGameObjectID, in_uFlags, (in_uFlags == 0) ? IntPtr.Zero : ((IntPtr)1), (in_pCookie == null) ? IntPtr.Zero : ((IntPtr)in_pCookie.GetHashCode()), in_cExternals, AkExternalSourceInfo.getCPtr(in_pExternalSources), in_PlayingID);
		AkCallbackManager.SetLastAddedPlayingID(num);
		return num;
	}
	...
	public static uint PostEvent(string in_pszEventName, GameObject in_gameObjectID, uint in_uFlags, AkCallbackManager.EventCallback in_pfnCallback, object in_pCookie, uint in_cExternals, AkExternalSourceInfo in_pExternalSources)
	{
		...
		PreGameObjectAPICall(in_gameObjectID, akGameObjectID);
		in_pCookie = AkCallbackManager.EventCallbackPackage.Create(in_pfnCallback, in_pCookie, ref in_uFlags);
		uint num = AkSoundEnginePINVOKE.CSharp_PostEvent__SWIG_7(in_pszEventName, akGameObjectID, in_uFlags, (in_uFlags == 0) ? IntPtr.Zero : ((IntPtr)1), (in_pCookie == null) ? IntPtr.Zero : ((IntPtr)in_pCookie.GetHashCode()), in_cExternals, AkExternalSourceInfo.getCPtr(in_pExternalSources));
		AkCallbackManager.SetLastAddedPlayingID(num);
		return num;
	}
	...
	public static uint PostEvent(string in_pszEventName, GameObject in_gameObjectID, uint in_uFlags, AkCallbackManager.EventCallback in_pfnCallback, object in_pCookie, uint in_cExternals)
	{
		...
		PreGameObjectAPICall(in_gameObjectID, akGameObjectID);
		in_pCookie = AkCallbackManager.EventCallbackPackage.Create(in_pfnCallback, in_pCookie, ref in_uFlags);
		uint num = AkSoundEnginePINVOKE.CSharp_PostEvent__SWIG_8(in_pszEventName, akGameObjectID, in_uFlags, (in_uFlags == 0) ? IntPtr.Zero : ((IntPtr)1), (in_pCookie == null) ? IntPtr.Zero : ((IntPtr)in_pCookie.GetHashCode()), in_cExternals);
		AkCallbackManager.SetLastAddedPlayingID(num);
		return num;
	}
	...
	public static uint PostEvent(string in_pszEventName, GameObject in_gameObjectID, uint in_uFlags, AkCallbackManager.EventCallback in_pfnCallback, object in_pCookie)
	{
		...
		PreGameObjectAPICall(in_gameObjectID, akGameObjectID);
		in_pCookie = AkCallbackManager.EventCallbackPackage.Create(in_pfnCallback, in_pCookie, ref in_uFlags);
		uint num = AkSoundEnginePINVOKE.CSharp_PostEvent__SWIG_9(in_pszEventName, akGameObjectID, in_uFlags, (in_uFlags == 0) ? IntPtr.Zero : ((IntPtr)1), (in_pCookie == null) ? IntPtr.Zero : ((IntPtr)in_pCookie.GetHashCode()));
		AkCallbackManager.SetLastAddedPlayingID(num);
		return num;
	}
	...
	public static AKRESULT PrepareEvent(AkPreparationType in_PreparationType, string[] in_ppszString, uint in_uNumEvent, AkCallbackManager.BankCallback in_pfnBankCallback, object in_pCookie)
	{
		...
		try
		{
			return (AKRESULT)AkSoundEnginePINVOKE.CSharp_PrepareEvent__SWIG_2((int)in_PreparationType, intPtr, in_uNumEvent, IntPtr.Zero, (in_pCookie == null) ? IntPtr.Zero : ((IntPtr)in_pCookie.GetHashCode()));
		}
		finally
		{
			Marshal.FreeHGlobal(intPtr);
	...
	public static AKRESULT PrepareGameSyncs(AkPreparationType in_PreparationType, AkGroupType in_eGameSyncType, string in_pszGroupName, string[] in_ppszGameSyncName, uint in_uNumGameSyncs, AkCallbackManager.BankCallback in_pfnBankCallback, object in_pCookie)
	{
		...
		try
		{
			return (AKRESULT)AkSoundEnginePINVOKE.CSharp_PrepareGameSyncs__SWIG_2((int)in_PreparationType, (int)in_eGameSyncType, in_pszGroupName, intPtr, in_uNumGameSyncs, IntPtr.Zero, (in_pCookie == null) ? IntPtr.Zero : ((IntPtr)in_pCookie.GetHashCode()));
		}
		finally
		{
			Marshal.FreeHGlobal(intPtr);
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetObjectPosition(GetAkGameObjectID(in_GameObjectID), PosX, PosY, PosZ, FrontX, FrontY, FrontZ, TopX, TopY, TopZ);
	}
	...
	{
		return StringFromIntPtrWString(AkSoundEnginePINVOKE.CSharp_GetWindowsDeviceName(index, out out_uDeviceID));
	}
	...
	{
		return (ulong)((!(gameObject == null)) ? gameObject.GetInstanceID() : (-1));
	}
	...
	public static AKRESULT RegisterGameObj(GameObject gameObject)
	{
		...
		PostRegisterGameObjUserHook(result, gameObject, akGameObjectID);
		return result;
	}
	...
	public static AKRESULT UnregisterGameObj(GameObject gameObject)
	{
		...
		PostUnregisterGameObjUserHook(result, gameObject, akGameObjectID);
		return result;
	}
